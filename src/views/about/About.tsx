        ...
        <div className="About">
            ...
            <article ref={about}>
                ...
                <p>Inżynier z powołania. Uwielbiam gdy coś działa, ale najwięcej satysfakcji mam gdy działa po dobrej
                    przeprawie z wszystkimi co działać nie chce. Zasada jest prosta: nie odpuszczać aż się uda. Nie lubię przerostu teorii
            ...
            <article ref={work}>
                ...
                <p>
                    ...
                    aż po kraje zachodniej Europy. Mogę pochwalić się współpracą z takimi potęgami jak Saint Gobain, Owens Illinois, Philips Lightening (obecnie Signify)
                    Stoelzle, czy Isover.
                    ...
                    (przypadkiem zrobiłem uprawnienia UDT). Prace ślusarskie i spawalnicze też lubię i też potrafię. W wyniku tejże pracy zacząłem się też interesować
            ...
            <article ref={feature}>
                ...
                <p>
                    ...
                    lat zajmuję się (oraz bardzo interesuję się) programowaniem. Do dzisiaj nie wiem dlaczego padło na Javascript.
                    Ale to na nim się głównie skupiłem. Chociaż proste programowanie mikrokontrolerów w C++ też nie jest mi obce. No i jeszcze Raspberry.
            ...
            <article ref={programming}>
                ...
                <p>
                    Po prostu lubię to. Lubię opanować nowy temat i od razu gdzieś go zastosować. Może dlatego korzystam z technologii zarówno
                    ...
                    A więc, radzę sobie nieźle z node: w grę wchodzi oczywiście Express i coś co ostatnio spędza mi sen z powiek czyli Nest.
                    Nieodzowną częścią backendu są bazy danych. Jestem fanem baz mySql, ale z mongoDB też daję radę. Potrafię napisać serwer websocket. Uwierzytelnianie
                    i autoryzacje i logowania ogarniam, chociaż tematy bezpieczeństwa to temat rzeka który staram się zgłębiać kiedy tylko jest taka możliwość.
